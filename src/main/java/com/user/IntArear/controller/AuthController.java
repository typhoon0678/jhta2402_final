...
import com.user.IntArear.dto.TokenDto;
import com.user.IntArear.jwt.JwtFilter;
...
public class AuthController {
    ...
    @PostMapping("/login")
    public ResponseEntity<TokenDto> authorize(@RequestBody MemberRequestDto memberRequestDto) {
